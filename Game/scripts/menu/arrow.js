define(['../game'], function (game) {
    ...
    Arrow.prototype.move = function (cursors, buttons) {
    ...
    Arrow.prototype.tween = function (buttons, buttonNum) {
        game.add.tween(this.arrow)
            .to({
    ...
    Arrow.prototype.allowMovement = function () {
        game.time.events.add(255, (function () {
            this.arrow.canMove = true;
        }), this);
    };

    Arrow.prototype.activateButton = function (buttons, currentButton) {
