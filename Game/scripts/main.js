define(['game', 'states/BootState', 'states/LoadState', 'states/MenuState', 'states/PlayState',
        'states/HowToState', 'states/CreditsState', 'states/GameOverState','states/levels/Level1State', 'states/levels/Level2State', 'states/levels/Level3State', 'states/levels/Level4State',
    ...
    function (game, BootState, LoadState, MenuState, PlayState, HowToState, CreditsState, GameOverState,
              Level1State, Level2State, Level3State, Level4State, Prehistory1State, Prehistory2State, Prehistory3State, Prehistory4State) {
